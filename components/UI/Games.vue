<template>
  <div class="w-full h-full relative">
    <div class=" bg-black rounded-t-[0.625rem] px-2 pt-2 w-full flex items-center justify-between max-w-[14.125rem] absolute -top-16 right-1">
        <div :class="{'bg-[#141C29]':selectedGame === 0}" @click="selectGame(0)" class=" duration-200 w-[3.4375rem] h-[3.8125rem] rounded-t-[0.625rem] flex cursor-pointer">
            <img src="/images/up-or-down/updown.png" alt="" class=" m-auto">
        </div>
         <div :class="{'bg-[#141C29]':selectedGame === 1}" @click="selectGame(1)"  class=" duration-200  w-[3.4375rem] h-[3.8125rem] rounded-t-[0.625rem] flex cursor-pointer">
            <img src="/images/up-or-down/coming-soojn1.png" alt="" class=" m-auto">
        </div>
         <div :class="{'bg-[#141C29]':selectedGame === 2}" @click="selectGame(2)"  class="duration-200   w-[3.4375rem] h-[3.8125rem] rounded-t-[0.625rem] flex cursor-pointer">
            <img src="/images/up-or-down/coming-soojn2.png" alt="" class=" m-auto">
        </div>
         <div :class="{'bg-[#141C29]':selectedGame === 3}" @click="selectGame(3)"  class=" duration-200  w-[3.4375rem] h-[3.8125rem] rounded-t-[0.625rem] flex cursor-pointer">

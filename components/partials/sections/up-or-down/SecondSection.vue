    ...
    <div class=" w-full pb-10">
        <div class=" max-w-[71.8125rem]  mx-auto">
                <div class=" w-full flex">
                    <img src="/images/up-or-down/compgrp1.png" class=" m-auto" alt="">
                </div>

                <div class=" w-full flex flex-col items-center space-y-4">
                    <h1 class=" text-white text-center font-inter text-[5rem] font-extrabold">How to play</h1>

                    <div class=" w-full grid grid-cols-3 gap-7">
                        <div class=" relative w-full bg-[#1B2128] overflow-hidden box rounded-[0.625rem] h-[21.625rem] px-8 py-8 flex flex-col items-center justify-between">
                            <div class=" flex flex-col items-center space-y-2 relative z-20">
                                <h2 class=" text-white font-inter font-extrabold text-3xl">Connect your wallet</h2>
                                <p class=" text-white font-inter text-center text-[0.75rem] font-normal">
                                    Up & Down works with your Defi Wallet <br> extension
                                </p>
                            </div>
                           <div class=" w-full relative z-20">
                             <button class=" relative font-inter text-center rounded-lg w-full hover:rounded-3xl duration-200 text-white text-[1.07556rem] sm:text-[1.76606rem] font-bold bg-primary  h-[2.79063rem] sm:h-[4.58231rem]">Connect Wallet</button>
                           </div>
                        ...
                        <div class=" relative w-full bg-[#1B2128] overflow-hidden box rounded-[0.625rem] h-[21.625rem] px-8 pt-8 flex flex-col items-center justify-between">
                            <div class=" flex flex-col items-center space-y-2 relative z-20">
                                <h2 class=" text-white font-inter font-extrabold text-3xl">How to bet</h2>
                         ...
                         <div class=" relative w-full bg-[#1B2128] overflow-hidden box rounded-[0.625rem] h-[21.625rem] pl-8  pt-8 flex flex-col items-center justify-between">
                            <div class=" flex flex-col items-center space-y-2 relative z-20 ">
                                <h2 class=" text-white font-inter font-extrabold text-3xl">Watch and win!</h2>
                                <p class=" text-white font-inter text-center text-[0.75rem] font-normal">
                         ...
                         <div class=" col-span-3 relative w-full bg-[#1B2128] overflow-hidden box rounded-[0.625rem] h-[16.5rem] px-8  pt-8 flex flex-col items-center justify-between">
                          ...
                          <div class=" col-span-3 relative w-full bg-[#1B2128] overflow-hidden box rounded-[0.625rem] h-[16.5rem] px-8  py-8 flex flex-col items-center justify-between">
                            <div class=" flex flex-col items-center space-y-2 relative z-20">
                           ...
                           <div class=" w-full relative z-20 flex max-w-[26.25rem]">
                            <img src="/images/up-or-down/coins.png" class="  w-full h-[5.8125rem] object-cover" alt="">
                           </div>
